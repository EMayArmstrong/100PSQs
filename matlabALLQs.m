...
PSQLongList = AllSubQs("final.xlsx", "Sheet1", [2, 101]);
...
PSQCatB = PSQLongList.Ques(PSQLongList.Category == "B");
PSQCatC = PSQLongList.Ques(PSQLongList.Category == "C");
PSQCatD = PSQLongList.Ques(PSQLongList.Category == "D");
...
words = ["aka" "climate" "change" "address" "result" "own" "plant" "result" "impact" "perception" "thus" "way" ...
    ...
    "anyway" "down" "confidentially" "own" "next" "year" "give" "solve" "affect"];
...
NumTopWords = 20; % set number of words you would like included in the table
