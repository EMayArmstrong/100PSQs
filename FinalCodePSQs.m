...
PSQLongList = AllSubQs("RegionalTop100.xlsx", "Americas", [1, 101]);
...
TopTenPairs = topkngrams(bagWordPairs,15,'NGramLengths',2)
% table of top ten word triples
TopTenTriples = topkngrams(bagWordPairs,15,'NGramLengths',3)
...
visualizeCO(CONetwork,'NodeColor',[0.4660 0.6740 0.1880],'FontSize',14,'MarkerSize',20);